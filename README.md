...
Linux
Application Runtime (Node.js / Java / Python)
CI/CD Pipeline
Learning Outcomes
Integrating SonarQube into CI/CD pipelines
Automating code quality checks before deployment
Implementing Quality Gates for release validation
Understanding code smells, bugs, vulnerabilities, and technical debt
